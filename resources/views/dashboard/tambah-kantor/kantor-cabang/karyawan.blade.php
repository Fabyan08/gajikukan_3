    ...
    <div class="main-content" style="min-height: 731px;">
        <section class="section">
            <div class="section-header">
                ...
                <h1 style="text-transform: capitalize">Data Semua Karyawan Aktif Cabang {{ $tableName }}</h1>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="d-flex justify-between">
                                ...
                                @if ($karyawan->isNotEmpty())
                                    <form action="{{ route('kantor-cabang.delete_karyawan') }}" method="POST">
                                        @csrf
                                        @method('delete')
                                        ...
                                        <tbody>
                                            @foreach ($karyawan as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('kantor-cabang.gaji-karyawan.nonaktif', ['id' => $data->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('put')
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('kantor-cabang.gaji-karyawan.delete_id', ['id' => $data->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('delete')
                                                            <input type="text" name="table_name"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('kantor-cabang.karyawan.update', ['id' => $data->id]) }}"
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="tambah-modal">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('kantor-cabang.import_karyawan') }}" method="POST"
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="tambah-manual">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('kantor-cabang.insert_karyawan') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
