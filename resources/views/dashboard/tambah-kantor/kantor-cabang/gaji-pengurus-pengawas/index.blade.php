        ...
        <section class="section">
            <div class="section-header">
                <div class="section-header-back">
                  ...
                  <h1 style="text-transform: capitalize">Upload Excel Gaji / HR Pengurus & Pengawas Kantor Cabang
                    {{ $tableName }}</h1>
                                        ...
                                        <tbody>
                                            @foreach ($data_waktu as $waktu)
                                                <tr>
                                                    ...
                                                    <td>{{ $waktu->tahun }}</td>
                                                    <td>
                                                        <a href="{{ route('kantor-cabang.gaji-pengurus-pengawas.detail', ['slug' => $tableName, 'id_waktu' => $waktu->id]) }}"
                                                            class="btn btn-primary">Detail & Tambah
                                                            Data</a>
                                                    </td>
                                                    <td>
                                                        <form
                                                            action="{{ route('kantor-cabang.gaji-pengurus-pengawas.delete_waktus', ['id_waktu' => $waktu->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('delete')
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('kantor-cabang.gaji-pengurus-pengawas.store_waktu') }}" method="POST">
                        @csrf
