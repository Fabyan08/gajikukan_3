        ...
        <section class="section">
            <div class="section-header">
                <div class="section-header-back">
                    <a href="/kantor-cabang/gaji-pengurus-pengawas/detail/{{ $tableName }}/{{ $gaji->id }}"
                        class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
                </div>
                 <h1 style="text-transform: capitalize">Detail Gaji {{ $gaji->nama }} Bulan {{ $gaji->bulan }} Tahun
                    {{ $gaji->tahun }} - Kantor Cabang {{ $tableName }}</h1>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <a href="{{ route('kantor-cabang.gaji-pengurus-pengawas.print', ['id_waktu' => $id_waktu, 'id' => $gaji->id, 'table_name' => $tableName]) }}"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form
                        action="{{ route('kantor-cabang.gaji-pengurus-pengawas.update', ['id' => $id_waktu, 'id_waktu' => $gaji->id]) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
