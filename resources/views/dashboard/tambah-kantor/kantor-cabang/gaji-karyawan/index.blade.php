...
<h1 style="text-transform: capitalize">Upload Excel Gaji / HR Karyawan Kantor Cabang {{ $tableName }}
                </h1>                <div class="section-header-breadcrumb">
                                        ...
                                        <tbody>
                                            @foreach ($data_waktu as $waktu)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('kantor-cabang.gaji-karyawan.detail', ['slug' => $tableName, 'id_waktu' => $waktu->id]) }}"
                                                            class="btn btn-primary">Detail & Tambah Data</a>
                                                    </td>

                                                    <td>
                                                        <form
                                                            action="{{ route('kantor-cabang.gaji-karyawan.delete_waktus', ['id_waktu' => $waktu->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('delete')
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('kantor-cabang.gaji-karyawan.store_waktu') }}" method="POST">
                        @csrf
