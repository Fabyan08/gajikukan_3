        ...
        <section class="section">
            <div class="section-header">
                <div class="section-header-back">
                    <a href="/kantor-cabang/gaji-karyawan/detail/{{ $tableName }}/{{ $gaji->id }}"
                        class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
                </div>
                 <h1 style="text-transform: capitalize">Detail Gaji {{ $gaji->nama }} Bulan {{ $gaji->bulan }} Tahun {{ $gaji->tahun }} - Kantor Cabang {{ $tableName }}</h1>
                                ...
                                <table class="table table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->tunjangan_makan)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Tunjangan Transport</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->tunjangan_transport)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Tunjangan Senja</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->tunjangan_senja)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Tunjangan Hadir</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->tunjangan_hadir)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Tunjangan Jabatan</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->tunjangan_jabatan)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Tunjangan Komunikasi</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->tunjangan_komunikasi)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Tunjangan Natura</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->tunjangan_natura)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Reward Lending</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->reward_lending)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Reward Funding</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->reward_funding)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">BPJS TK</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->bpjs_tk)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">BPJS Kesehatan</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->bpjs_kesehatan)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Gaji Kotor</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->gaji_kotor)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Potongan BPJS TK Kesehatan</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->potongan_bpjs_tk_kesehatan)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Potongan Angsuran</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->potongan_angsuran)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Potongan Ijin</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->potongan_ijin)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Potongan Zis</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->potongan_zis)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Potongan Pensiun</th>
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->potongan_pensiun)), 2, ',', '.') }}
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td  style="text-align: end">Rp {{ number_format(floatval(str_replace(',', '.', $gaji->gaji_bersih)), 2, ',', '.') }}
                                            </td>
                                        </tr>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form
                        action="{{ route('kantor-cabang.gaji-karyawan.update', ['id' => $id_waktu, 'id_waktu' => $gaji->id]) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
