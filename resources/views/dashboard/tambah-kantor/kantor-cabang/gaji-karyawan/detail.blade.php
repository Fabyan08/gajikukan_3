        ...
        <section class="section">
            <div class="section-header">
                ...
                <h1 style="text-transform: capitalize">Data Ter-Upload Excel Gaji Bulan {{ $waktu->bulan }} Tahun
                    {{ $waktu->tahun }} - HR Karyawan Kantor Cabang {{ $tableName }}</h1>
                                        ...
                                        <tbody>
                                            @foreach ($data_gaji as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{-- <a href="{{ route('kantor-cabang.gaji-karyawan.detail_gaji', ['slug' => $tableName, 'id_waktu' => $data->id_waktu, 'id' => $data->id]) }}"
                                                            class="btn btn-primary">Detail</a> --}}
                                                        <a href="/kantor-cabang/gaji-karyawan/detail/{{ $tableName }}/{{ $data->id_waktu }}/{{ $data->id }}"
                                                            class="btn btn-primary">Detail</a>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('kantor-cabang.gaji-karyawan.print', ['id_waktu' => $data->id, 'id' => $data->id_waktu, 'table_name' => $tableName]) }}"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form
                        action="{{ route('kantor-cabang.gaji-karyawan.import', ['slug' => $tableName, 'id_waktu' => $waktu->id]) }}"
