                                        ...
                                        <tbody>
                                            @foreach ($data_waktu as $waktu)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('pph.detail_cabang', ['slug' => $kantor, 'id_waktu' => $waktu->id]) }}"
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('pph.delete_waktu_cabang', ['slug' => $kantor, 'id' => $waktu->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('delete')
                                                            <button
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('pph.store_waktu_cabang', ['slug' => $kantor]) }}" method="POST">
                        @csrf
                        <div class="mt-4">
