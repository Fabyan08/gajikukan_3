    ...
    <div class="main-content" style="min-height: 731px;">
        <section class="section">
            <div class="section-header">
                <h1>Data Semua Karyawan Aktif</h1>
            ...
            <div class="section-body">
                ...
                <div class="d-flex" style="align-items: center; gap: 10px">
                    <h2 class="section-title">Unduh Template Excel-></h2> <a href="/template-file/Data HR Karyawan.csv"
                                        ...
                                        <tbody>
                                            @foreach ($karyawan as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('data-karyawan.nonaktif', ['id' => $data->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('put')
                                                            <button
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('data-karyawan.delete_id', ['id' => $data->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('delete')
                                                            <button
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('data-karyawan.update', ['id' => $data->id]) }}" method="POST"
