    ...
    <div class="main-content" style="min-height: 731px;">
        <section class="section">
            <div class="section-header">
                ...
                <h1>Data Ter-Upload Excel Gaji Bulan {{ $waktu->bulan }} Tahun {{ $waktu->tahun }} - HR Pengurus &
                    Pengawas</h1>
            ...
            <div class="section-body">
                <h2 class="section-title">Klik Detail Untuk Tahu Lebih Lanjut</h2>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="d-flex justify-between">
                                ...
                                @if ($data_gaji->isNotEmpty())
                                    <form action="{{ route('gaji-pengurus.delete', ['id_waktu' => $waktu->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('delete')
                                        <button
                                        ...
                                        <tbody>
                                            @foreach ($data_gaji as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('gaji-pengurus.detail', ['id_waktu' => $data->id_waktu, 'id' => $data->id]) }}"
                                                            class="btn btn-primary">Detail</a>

                                                        {{-- <a href="/" class="btn btn-primary">Detail</a> --}}
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('gaji-pengurus.print_slip', ['id_waktu' => $data->id_waktu, 'id' => $data->id]) }}"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('gaji-pengurus.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
