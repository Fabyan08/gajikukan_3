<x-app-layout>
 ...
 <h1 style="text-transform: capitalize">Upload Excel Gaji / HR Karyawan
                                        ...
                                        <tbody>
                                            @foreach ($data_waktu as $waktu)
                                                <tr>
                                                    ...
                                                    <td>{{ $waktu->bulan }}</td>
                                                    <td>{{ $waktu->tahun }}</td>
                                                    <td><a href="{{ route('upload.detail', $waktu->id) }}"
                                                            class="btn btn-primary">Detail & Tambah
                                                            Data</a></td>
                                                    <td>
                                                        <form
                                                            action="{{ route('gaji.delete_waktus', ['id_waktu' => $waktu->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('delete')
                                                            <button
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('upload.store_waktu') }}" method="POST">
                        @csrf
                        <div class="mt-4">
